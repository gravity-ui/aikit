...
| `autoScroll`                | `boolean`                              | -                  | `true`    | Keep the message list pinned to the bottom as the conversation advances. `false` leaves scroll position entirely under the user's control — note the chat then opens at the top of the history. See the [MessageList README](../../organisms/MessageList/README.md#auto-scroll) |

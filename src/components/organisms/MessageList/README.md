...
const messages: TChatMessage[] = [
  ...
  },
  {
    ...
    content: 'Hi there!',
    userRating: 'like', // optional: 'like' | 'dislike' — affects like/dislike button icons
  },
];
...
| `loaderMessage`                 | `string`                                                                 | -        | -                                    | Loader message next to a loader                                                                                                                            |
| `withLoaderShimmer`             | `boolean`                                                                | -        | `false`                              | Apply a shimmer animation to `loaderMessage` while the loader is visible                                                                                   |
...
| `getMarkdownCodeBlockActions`   | `(message: TChatMessage) => MarkdownCodeBlockActionsConfig \| undefined` | -        | -                                    | Resolves [fenced code block actions](../../atoms/MarkdownRenderer/README.md#fenced-code-block-actions) per message for default text renderers              |

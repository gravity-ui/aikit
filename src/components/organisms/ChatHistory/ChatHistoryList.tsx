...
/**
 * Props for the ChatHistoryList component
 */
export interface ChatHistoryListProps extends QAProps, DOMProps {
    /** Array of chat items */
    chats: ChatType[];
...
/**
 * ChatHistoryList component - displays a list of chats with search, grouping, and actions
 *

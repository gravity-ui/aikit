...
// Wrapper component that includes trigger button, state, and ChatHistory
type ChatHistoryWithTriggerProps = Omit<ChatHistoryProps, 'open' | 'onOpenChange' | 'anchorRef'> & {
    initialOpen?: boolean;
};

function ChatHistoryWithTrigger({initialOpen = true, ...props}: ChatHistoryWithTriggerProps) {
...
export const Playground: Story = {
    ...
    render: (args) => <ChatHistoryWithTrigger {...args} />,
...
export const NotForceOpen: Story = {
    ...
    render: (args) => <ChatHistoryWithTrigger initialOpen={false} {...args} />,
    decorators: defaultDecorators,
};

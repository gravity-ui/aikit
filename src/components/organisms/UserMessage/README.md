...
| `codeBlockActions`              | `MarkdownCodeBlockActionsConfig` | -        | -         | [Fenced code block actions](../../atoms/MarkdownRenderer/README.md#fenced-code-block-actions) for markdown messages |
